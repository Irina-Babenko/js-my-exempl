...
// //! Цикл while
// //* цикл с предпосылкой, то есть он выполняется до тех пор, пока истинно определенное условие, указанное перед его началом.
// //?
...
// //! Цикл do…while
// //* код в теле цикла выполняется по крайней мере один раз даже если условие не выполняется с самого начала.
